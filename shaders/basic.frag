...
uniform int       iFrame;                // shader playback frame // channel resolution (in pixels)
uniform vec4      iMouse;                // mouse pixel coords. xy: current (if MLB down), zw: click         // input channel. XX = 2D/Cube
uniform vec4      iDate;
